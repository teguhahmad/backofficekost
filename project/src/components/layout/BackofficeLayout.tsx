...
const BackofficeLayout: React.FC<BackofficeLayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    ...
    { id: 'properties', label: 'Properties', icon: <Building2 size={20} />, path: '/properties' },
    { id: 'notifications', label: 'Notifications', icon: <Bell size={20} />, path: '/notifications' },
    { id: 'subscription-plans', label: 'Subscription Plans', icon: <CreditCard size={20} />, path: '/subscription-plans' },
    { id: 'role-permissions', label: 'Role & Permissions', icon: <Shield size={20} />, path: '/role-permissions' },
